...
const ConfirmCheckIn = () => {
  ...
  try {
    const res = await attendanceApi.checkIn({
      ...
      clientTime: clickTime.toISOString(), // optional (for logs/debug)
    });
    ...
    await Swal.fire({
      ...
      text: "Mark Attendance Successfully",
      width: 300,
      padding: "1em",
      timer: 1500,
    ...
    // After popup, navigate to employee home
    navigate("/employee");
...
>
  ...
  {/* ===== BACK BUTTON ===== */}
<button
  onClick={() => navigate("/attendance/check-in")}   // or navigate(-1)
  title="Back"
